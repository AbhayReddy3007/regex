...
- If both percent and kg values are present, include both in `extracted` and set `selected_percent` and/or `selected_kg` to indicate the LLM's best choice for each unit.
